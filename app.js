...
function setup(shaders) {
    ...
    */
    ...
    function drawHelicopter(x, y, z, r) {
        ...
        heli.position[0] = RADIUS * Math.cos(heli.r * 2 * Math.PI / 360);
        heli.position[2] = RADIUS * Math.sin(heli.r * 2 * Math.PI / 360);
