...
function _build() {
    _addFace(0, 1, 2, 3, vec3(0, -1, 0));
    _addTriangle(0, 1, 4, vec3(0, 0, 1));
    _addTriangle(1, 2, 4, vec3(1, 0, 0));
    _addTriangle(2, 3, 4, vec3(0, 0, -1));
    _addTriangle(3, 0, 4, vec3(-1, 0, 0));
}
